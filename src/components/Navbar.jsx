    ...
    <div className="navbar bg-base-100 font-protestRiot fixed top-0 z-50 border-b-2 border-white shadow-md shadow-orange-200">
      ...
      <div className="flex-none gap-2">
        ...
        <div className="dropdown relative">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-44 p-2 shadow space-y-2 absolute top-10 -right-10"
          >
            {tabs}
          </ul>
        </div>
          ...
          <>
            <div className="dropdown dropdown-end" title={user?.displayName}>
              ...
              >
                ...
                <li
                  className="border-2 font-bold mt-2 rounded-xl"
